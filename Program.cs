                    ...
                    try
                    {
                        ...
                        switch (param)
                        {
                            case 0:
                                ...
                                break;
                            case 1:
                                Messaging("Запись расхода нефти по АТ-1 успешно добавлена в базу данных \n");
                                break;
                            case 2:
                                Messaging("Запись расхода нефти по АТ-2 успешно добавлена в базу данных \n");
                                break;
                            case 3:
                                Messaging("Запись расхода нефти по АТ-3 успешно добавлена в базу данных \n");
                                break;
                            case 4:
                                Messaging("Запись расхода нефти по АТ-4 успешно добавлена в базу данных \n");
                                break;
                            case 5:
                                Messaging("Запись расхода нефти по АТ-5 успешно добавлена в базу данных \n");
                                break;
                        }
                    }
